...
tags: jsdocs, markdown, mermaid, JavaScript, Node.js, Gitlab.com
---
...
1. We want to encourage the user to use the docs, so what's something simple we can do to help there? 
...
3. Use "Callouts" for Scannability
